...
exports.finishCourse = async (req, res) => {
    const output = `
    <p style="font-size: 16px">${req.body.name}, успешно завершил курс!</p>
    <h3 style="font-size: 24px;">Курс завершен</h3>
  `;
    ...
    let mailOptions = {
        ...
        subject: 'Завершение курса', // Subject line
...
exports.nodemailerRegistration = async (req, res) => {
    const output = `
    <p style="font-size: 16px">${req.body.name}, Вы были успешно зарегестрированы</p>
    <h3 style="font-size: 24px;">Данные для входа:</h3>
    <ul>
         <li style="font-size: 18px; list-style: none">Почта: ${req.body.email}</li>  
...
exports.nodemailerCall = async (req, res) => {
    const output = `
    <p style="font-size: 16px">Видеозвонок Tele-Rehab</p>
    <h3 style="font-size: 24px;">Поступил звонок на сайте Tele-Rehab</h3>
  `;
...
exports.nodemailerFeedback = async (req, res) => {
    const output = `
    <p style="font-size: 16px">Обратная связь</p>
    <h3 style="font-size: 24px;">Данные для связи</h3>
    <ul>
      <li style="font-size: 18px; list-style: none">Имя: ${req.body.username}</li>      
      <li style="font-size: 18px; list-style: none">Тема: ${req.body.theme}</li>
      <li style="font-size: 18px; list-style: none">Детали: ${req.body.text}</li>      
      <li style="font-size: 18px; list-style: none">Почта пользователя: ${req.body.email}</li>      
    </ul>
  `;
