            ...
            <div className="footer-right">
              ...
              <div className="footer-form">
                <form onSubmit={(e) => sendMsg(e)} name="footer-form" id="footer-form">
                  <input type="text" onChange={(e) => setName(e.target.value)} placeholder="Имя" required/>
                  {/*<input type="tel" onChange={(e) => setPhone(e.target.value)} minLength="13" maxLength="13" placeholder="Номер телефона" required/>*/}
                  <InputMask
